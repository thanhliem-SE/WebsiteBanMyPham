...
GO
INSERT [dbo].[SanPham] ([maSanPham], [congDung], [donGia], [donViTinh], [hanSuDung], [maNhaCungCap], [soLuongTon], [tenSanPham], [thanhPhan], [thue], [maDanhMuc], [maNhanVien], [giamGia]) VALUES (17, N'Nước uống bổ sung Collagen cần thiết cho da, cân bằng độ ẩm đồng thời làm giảm và ngăn chặn tình trạng lão hóa da mang đến cho bạn làn da căng mọng, tươi tắn, tràn đầy sức sống. ', 1850000, N'Hộp', 24, 6, 10, N'VITAL BEAUTIE Super Collagen - Nước uống bổ sung Collagen', N'Contains 1000mg of Hydrolysed Collagen, Purified Water, Orange Concentrate, Citric Acid, Pectin, Sodium Oral Ginseng, Enzyme Treated Stevia, Tea Powder, Calcium Powder Mixture, Hyaluronic Acid, Bonito Fish Protein Hydrolysate, Vitamin C', 0.5, 6, 1, 10)
GO
...
Sheet mask Pouch: Opuntia Ficus-Indica Stem Extract, Aqua, Glycerin, Niacinamide, Alcohol, Methylpropanediol, Althaea rosea Flower Extract, Gossypium herbaceum (Cotton) Extract, Buddleja davidii Extract, Thymus vulgaris (Thyme) Extract, Leontopodium alpinum Flower/Leaf Extract, 1,2-Hexanediol, Hydroxyacetophenone, Choleth-24, Arginine, Allantoin, Silica, Butylene Glycol, Ethylhexylglycerin, Glutathione, Gluconolactone, Calcium Gluconate, Carbomer, Caffeine, Xanthan Gum, Disodium EDTA, Sodium Benzoate, Fragrance.', 0.5, 5, 1, 10)
GO
