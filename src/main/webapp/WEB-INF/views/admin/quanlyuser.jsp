									...
									<tbody>
										...
										<c:forEach var="element" items="${listKH}">
											<tr>
												...
												<td>
													<div class="row">
														<a style="text-align: center" data-toggle="modal" data-target="#modalEditKhachHang${element.user.username}"><i class="fas fa-edit"></i></a>
														<!-- The Modal -->
														...
														&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; <a
														onclick="return confirm('Bạn muốn xoá khách hàng này phải không?');"
														href="${pageContext.request.contextPath}/admin/deleteKH?username=${element.user.username}"
