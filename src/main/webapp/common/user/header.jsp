		...
		<nav class="navbar navbar-expand-md bg-dark navbar-dark">
			...
			<div class="collapse navbar-collapse justify-content-between"
				...
				<div class="navbar-nav mr-auto">
					<a href="${pageContext.request.contextPath}/trangchu" class="nav-item nav-link active">Home</a> <a
						href="${pageContext.request.contextPath}/product" class="nav-item nav-link">Products</a> <a
						href="product-details" class="nav-item nav-link">Product
						Detail</a> <a href="cart" class="nav-item nav-link">Cart</a> <a
						href="checkout" class="nav-item nav-link">Checkout</a> <a
						href="account" class="nav-item nav-link">My Account</a>
...
<div class="bottom-bar">
	<div class="container-fluid">
		<div class="row align-items-center">
			<div class="col-md-3">
				<div class="logo">
					<a href="/mypham/trangchu"> <img src="${url}/img/logo.png" alt="Logo">
					</a>
				</div>
			</div>
			<div class="col-md-6">
			...
			<div class="col-md-3">
				<div class="user">
					<a href="${pageContext.request.contextPath}/wish" class="btn wishlist"> <i
