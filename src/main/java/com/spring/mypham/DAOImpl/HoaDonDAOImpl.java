...
public class HoaDonDAOImpl implements HoaDonDAO{
	...
	/*select hd.maHoaDon,hd.ngayLap,string_agg(sp.tenSanPham+' *'+convert(nvarchar(10),li.soLuong)+' '+sp.donViTinh,char(10)) tenCacSanPham,SUM(li.thanhTien),hd.trangThaiHoaDon from HoaDon hd join LineItem li 
ON hd.maHoaDon = li.maHoaDon JOIN GioHang gh ON li.maGioHang = gh.maGioHang JOIN KhachHang kh 
ON kh.maKhachHang=gh.maKhachHang JOIN SanPham sp ON li.maSanPham=sp.maSanPham where kh.username like 'hung123'
